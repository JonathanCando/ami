							...
							<!-- Header -->
								<div id="header">
									...
									<!-- Nav -->
										<nav id="nav">
											<ul>
												<li class="current_page_item"><a href="index.html">Recetas</a></li>
												<li>
													<span>Médico</span>
													<ul>
												...
												<li><a href="right-sidebar.html">Cita medica</a></li>
												<li><a href="left-sidebar.html">Solicitudes</a></li>
												<li><a href="no-sidebar.html">Farmacias</a></li>
											</ul>
										</nav>
									<!-- /Nav -->
